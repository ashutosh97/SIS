...
// Check connection
			...
			$sql="update regform set email='$mail',degree='$dg',dept='$dpt',rollno='$rolln',regno='$regn',sem='$sm',cgpa='$cgpa',yearofpass='$yrpss',res_path='$res_path',fname='$fnme',lname='$lnme',contact='$cntct',gender='$gndr',dob='$dte',age='$ag',address='$adrs',image_path='$img_path',status='$sts' where username='$user'";
			$result=mysqli_query($con,$sql);
			if($result>0)
			{
				echo "<h1>Entry Updated Successfully!</h1>";
			}
			else{
