...
// Check connection
			...
			if($result>0)
			{
				echo "<h1>Entry Uploaded Successfully!!<span>Waiting for activation by the admin...</span></h1>";
			}
			else{
				die('Failed to update site table. Mysql returned the following:<br><br>'.mysqli_error($con));
			}	
